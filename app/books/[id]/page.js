...
import BookDetails from './BookDetails'; // New Client Component

import { bookData } from "../../data/books";
 // Move your mock data here

export async function generateStaticParams() {
  return Object.keys(bookData).map(id => ({ id }));
}
...
// export async function generateStaticParams() {
//   const bookIds = Object.keys(bookData); // Get all book IDs
//   return bookIds.map(id => ({
//     id: id.toString(), // Return each ID as a string
//   }));
// }
